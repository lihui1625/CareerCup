...
public class Exam_062 {
	...
	public static String longestCommonSubquence2(String s1, String s2) {
		if (s1 == null || s2 == null) {
			return null;
		}
		int len1 = s1.length();
	...
	public static String longestCommonSubquence3(String s1, String s2) {
		if (s1 == null || s2 == null) {
			return null;
		}
		int len1 = s1.length();
	...
	public static void main(String[] args) {
		...
		String result2 = longestCommonSubquence2(s1, s2);
